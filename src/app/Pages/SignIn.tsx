      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="flex items-center gap-3 mb-10">
            ...
            <h1 className="text-3xl font-bold text-foreground tracking-tight">FaithCare</h1>
          </div>
        ...
        <div className="max-w-lg">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-5">
              <div
                className="w-10 h-10 rounded-xl flex items-center justify-center mt-1 bg-success/10 border border-success/20 shadow-inner"
              >
                <div
              ...
              <div>
                <p className="text-foreground font-bold text-lg">Member Care Management</p>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Track first timers, prayer requests, and follow-ups with automated tools.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-5">
              ...
              <div>
                <p className="text-foreground font-bold text-lg">Spiritual Productivity</p>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Daily scripture, journaling, and focus tools designed for modern believers.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-5">
              ...
              <div>
                <p className="text-foreground font-bold text-lg">Built for Young Professionals</p>
                <p className="text-sm text-muted-foreground leading-relaxed">
                  Modern, intuitive design that fits your lifestyle and elevates your experience.
                </p>
              </div>
            </div>
          </div>
