...
export function SundayJournal() {
  ...
  return (
    <div className="min-h-full flex flex-col">
      <Header title="Sunday Journal" subtitle="Reflect on this week's message and what God is teaching you."/>
      
      <div className="p-4 md:p-8 flex flex-col lg:flex-row gap-6 flex-1">
        {/* Main Editor */}
        <div className="flex-1 bg-card rounded-xl border border-border p-6 md:p-8 shadow-sm">
          {/* Title */}
          <input
            type="text"
            ...
            className="w-full text-3xl font-semibold text-foreground placeholder:text-muted-foreground bg-transparent border-none outline-none mb-6"
          />
        ...
        <div className="w-full lg:w-80 bg-card rounded-xl border border-border p-6 shadow-sm h-fit">
          ...
          <div className="space-y-3">
            {previousEntries.map((entry) => (
              ...
              >
                <p className="text-foreground group-hover:text-accent transition-colors mb-1 font-medium">
                  {entry.title}
                </p>
