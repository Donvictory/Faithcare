    ...
    <>
      ...
      <div className="min-h-screen bg-background font-sans selection:bg-accent/20 relative overflow-hidden grain-overlay">
        ...
        <nav className="fixed top-0 left-0 right-0 bg-background/85 backdrop-blur-xl z-50 border-b border-border/40">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            <div className="flex items-center gap-2 transition-spring hover:opacity-80">
              ...
              <span className="text-[1.125rem] font-bold text-foreground tracking-tight">
                FaithCare
              </span>
            </div>
            <div className="flex items-center gap-6">
              ...
              <Link
                to="/sign-up-choice"
                className="text-[0.875rem] font-semibold bg-foreground text-background px-5 py-2.5 rounded-[8px] hover:bg-foreground/90 transition-spring hover:-translate-y-[1px] hover:shadow-card active:translate-y-0 active:shadow-none"
              >
                Get Started
              </Link>
            </div>
        ...
        <main>
          ...
          <section className="relative min-h-screen flex items-center pt-32 pb-32 overflow-hidden bg-grid-subtle">
            ...
            <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
              <div className="grid lg:grid-cols-12 gap-16 lg:gap-8 items-center">
                ...
                <div className="lg:col-span-7 flex flex-col justify-center text-left">
                  ...
                  <h1 className="animate-fade-up delay-100 text-[2.75rem] lg:text-[3.5rem] xl:text-[4rem] font-extrabold text-foreground tracking-[-0.03em] leading-[1.1] mb-4 xl:mb-6">
                    Structure Your Ministry.
                    <br />
                    <span className="text-accent">Deepen Your Faith.</span>
                  </h1>

                  <p className="animate-fade-up delay-200 text-[1rem] lg:text-[1.125rem] xl:text-[1.25rem] text-muted-foreground max-w-[55ch] leading-[1.6] mb-6 xl:mb-10">
                  ...
                  <div className="animate-fade-up delay-300 flex flex-col sm:flex-row items-start sm:items-center gap-3 xl:gap-4">
                    <Link
                      to="/sign-up-choice"
                      className="w-full sm:w-auto flex items-center justify-center gap-2 bg-accent text-accent-foreground px-6 py-3 xl:px-8 xl:py-4 rounded-[8px] text-[0.9375rem] xl:text-[1rem] font-semibold transition-spring hover:bg-accent/90 hover:shadow-glow hover:-translate-y-[2px] active:translate-y-0 active:shadow-none border border-accent"
                    >
                    ...
                    <Link
                      to="/sign-up-choice"
                      className="w-full sm:w-auto flex items-center justify-center gap-2 bg-transparent text-foreground px-6 py-3 xl:px-8 xl:py-4 rounded-[8px] text-[0.9375rem] xl:text-[1rem] font-medium border border-border/80 transition-spring hover:bg-secondary/50 hover:border-border hover:-translate-y-[1px] active:translate-y-0"
                    >
                      Join as Individual
                    </Link>
                  </div>

                  <p className="animate-fade-up delay-400 mt-6 xl:mt-8 text-[0.875rem] text-muted-foreground flex items-center gap-2 font-medium">
                ...
                <div className="lg:col-span-5 relative flex items-center justify-center animate-fade-up delay-500">
                  <div className="relative w-full max-w-[320px] xl:max-w-[400px] aspect-[4/5] rounded-[24px] bg-secondary border border-border/50 shadow-premium overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-background to-secondary/50" />

                    {/* Floating UI Elements inside */}
                    <div className="absolute inset-0 p-6 xl:p-8 flex flex-col gap-4 xl:gap-6 animate-float">
                      {/* Mockup Card 1: First Timer */}
                      <div className="bg-card border border-border/40 rounded-[12px] p-4 xl:p-5 shadow-card transition-spring hover:-translate-y-[2px] hover:shadow-premium cursor-default">
                        <div className="flex items-center gap-3 xl:gap-4 mb-3 xl:mb-4">
                          <div className="w-10 h-10 xl:w-12 xl:h-12 rounded-full bg-accent/20 flex items-center justify-center">
                            <Users className="w-5 h-5 xl:w-6 xl:h-6 text-accent" />
                          </div>
                          <div>
                            <p className="text-[0.9375rem] xl:text-[1rem] font-semibold text-foreground leading-[1.2]">
                              John Doe
                            </p>
                            <p className="text-[0.6875rem] xl:text-[0.75rem] text-muted-foreground mt-1">
                              First Timer • Attended Sunday
                            </p>
                          </div>
                        </div>
                        <div className="h-[1px] w-full bg-border/40 mb-3 xl:mb-4" />
                        <div className="flex justify-between items-center text-[0.6875rem] xl:text-[0.75rem]">
                          <span className="text-muted-foreground flex items-center gap-1">
                            <Clock className="w-3 h-3" /> 2 days ago
                          </span>
                          <span className="text-success font-medium bg-success/10 px-2 py-0.5 rounded-[4px]">
                            Follow-up Needed
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="bg-card border border-border/40 rounded-[12px] p-4 xl:p-5 shadow-card ml-4 xl:ml-6 relative z-10 transition-spring hover:-translate-y-[2px] hover:shadow-premium cursor-default">
                        <div className="flex justify-between items-start mb-2 xl:mb-3">
                          <div className="flex items-center gap-2 text-[0.8125rem] xl:text-[0.875rem] font-medium text-foreground">
                            <MessageSquare className="w-4 h-4 text-primary" />
                            Admin Feedback
                          </div>
                          <span className="text-[0.6875rem] xl:text-[0.75rem] text-muted-foreground">
                            10:30 AM
                          </span>
                        </div>
                        <p className="text-[0.8125rem] xl:text-[0.875rem] text-muted-foreground leading-[1.5]">
                          "Hi John, it was great having you at service this
                          Sunday. Do you have any prayer requests?"
                        </p>
                      </div>

                      {/* Mockup Card 3: WhatsApp Action */}
                      <div className="bg-success text-success-foreground rounded-[12px] p-3 xl:p-4 shadow-card flex items-center justify-between mr-4 xl:mr-6 mt-1 xl:mt-2 transition-spring hover:-translate-y-[2px] hover:shadow-premium cursor-pointer">
                        <div className="flex items-center gap-2 xl:gap-3">
                          <Smartphone className="w-4 h-4 xl:w-5 xl:h-5" />
                          <span className="text-[0.8125rem] xl:text-[0.875rem] font-semibold">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-card p-8 rounded-[16px] border border-border transition-spring hover:-translate-y-[4px] hover:shadow-card hover:border-border"
                  >
                    ...
                    <h3 className="text-[1.25rem] font-bold text-foreground leading-[1.3] mb-3">
                      {problem.title}
                    </h3>
                    <p className="text-[1rem] text-muted-foreground leading-[1.6]">
                      {problem.desc}
                    </p>
                  </div>
                ))}
                ...
                <div className="lg:col-span-6 order-1 lg:order-2">
                  ...
                  <ul className="space-y-5">
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        <span className="text-[1rem] font-semibold text-foreground block mb-1">
                          Transparent History
                        </span>
                        <span className="text-[0.875rem] text-muted-foreground leading-[1.5] block">
                    ...
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <span className="text-[0.875rem] text-muted-foreground leading-[1.5] block">
                          Organizations manage members. Members don't need their
                          own login, keeping friction at absolute zero.
                        </span>
                      </div>
                    </li>
                  </ul>
              ...
              <div className="grid lg:grid-cols-12 gap-16 items-center">
                <div className="lg:col-span-6">
                  ...
                  <p className="text-[1.125rem] text-muted-foreground leading-[1.6] max-w-[55ch] mb-8">
                    ...
                    FaithCare connects your church directly to your members'
                    phones.
                  </p>
                  <ul className="space-y-5">
                    <li className="flex items-start gap-4">
                ...
                <div className="lg:col-span-6 bg-secondary rounded-[24px] p-2 border border-border/50 shadow-inner overflow-hidden flex items-center justify-center max-h-[500px]">
                  <div className="w-full h-full rounded-[20px] overflow-hidden border border-border/40 shadow-premium bg-background">
                    <img
                      src="/images/features/admin-messaging.png"
          ...
          <section className="py-24 lg:py-[128px] bg-secondary/20 border-t border-border/30">
            <div className="max-w-7xl mx-auto px-6">
              <div className="text-center max-w-[65ch] mx-auto mb-20 lg:mb-[128px]">
                ...
                <p className="text-[1.125rem] text-muted-foreground leading-[1.6]">
                  FaithCare isn't just an administration tool for churches. It's
                  a powerful, independent daily companion for individuals on
                  ...
                  <ul className="space-y-5">
                    <li className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <span className="text-[0.875rem] text-muted-foreground leading-[1.5] block">
                          Follow a structured reading plan with the "This Week's
                          Focus" timeline to stay grounded and grow consistently
                          in your faith.
                        </span>
                      </div>
                    </li>
          ...
          <section className="py-[128px] bg-foreground text-background relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
              ...
              <p className="text-[1.25rem] text-background/70 mb-10 max-w-[55ch] mx-auto leading-[1.6]">
                Whether you're organizing a ministry or building your personal
                spiritual habits, FaithCare is built for you.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  to="/sign-up-choice"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-accent text-accent-foreground px-10 py-5 rounded-[8px] text-[1.125rem] font-bold transition-spring hover:bg-accent/90 hover:-translate-y-[2px] hover:shadow-glow active:translate-y-0 border border-accent"
                >
                  Register Organization
                ...
                <Link
                  to="/sign-up-choice"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-transparent text-background px-10 py-5 rounded-[8px] text-[1.125rem] font-medium transition-spring hover:bg-background/10 hover:-translate-y-[2px] active:translate-y-0 border border-background/30"
                >
                  Join as Individual
                </Link>
              </div>
